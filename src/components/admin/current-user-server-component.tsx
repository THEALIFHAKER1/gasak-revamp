import { requireAdmin, getCurrentUserData } from "@/lib/auth";
import {
  Card,
  CardContent,
  CardDescription,
...
/**
 * Server Component - Current User Profile
 * Fetches current user data server-side with automatic admin verification
 */
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Your profile data fetched server-side
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <ul className="list-inside list-disc space-y-1 text-sm">
                ...
                <li>Automatic admin verification</li>
